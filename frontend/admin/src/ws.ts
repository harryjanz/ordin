...
// ORD-119 — cópia de frontend/balcao/src/ws.ts (mesmo padrão de reconexão
// com backoff exponencial + ping/pong). Primeiro cliente WebSocket do
// admin (FulfillmentScreen).
