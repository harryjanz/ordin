...
const S = {
  page: { padding: 32, color: "var(--a-text)", maxWidth: 1180 } as React.CSSProperties,
  ...
  filterbar: { display: "grid", gridTemplateColumns: "2fr 1.3fr 1fr auto", gap: 12, alignItems: "end", background: "var(--a-surface)", border: "1px solid rgba(153,0,255,0.2)", borderRadius: 14, padding: "18px 20px", marginBottom: 18 } as React.CSSProperties,
  field: { display: "flex", flexDirection: "column", gap: 6 } as React.CSSProperties,
  label: { fontSize: 11, fontWeight: 600, color: "rgba(var(--a-text-rgb),0.5)", textTransform: "uppercase", letterSpacing: "0.04em" } as React.CSSProperties,
  input: { fontSize: 13.5, color: "var(--a-text)", background: "var(--a-bg)", border: "1px solid rgba(var(--a-neutral-rgb),0.09)", borderRadius: 9, padding: "10px 12px", outline: "none", width: "100%" } as React.CSSProperties,
  filterCount: { fontSize: 12, color: "rgba(var(--a-text-rgb),0.5)", marginBottom: 14 } as React.CSSProperties,
  tablewrap: { background: "var(--a-surface)", border: "1px solid rgba(153,0,255,0.2)", borderRadius: 14, overflow: "hidden" } as React.CSSProperties,
  table: { width: "100%", borderCollapse: "collapse" } as React.CSSProperties,
  th: { textAlign: "left", fontSize: 10.5, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em", color: "rgba(var(--a-text-rgb),0.5)", padding: "12px 18px", borderBottom: "1px solid rgba(var(--a-neutral-rgb),0.07)", background: "rgba(0,0,0,0.15)" } as React.CSSProperties,
  td: { padding: "14px 18px", borderBottom: "1px solid rgba(var(--a-neutral-rgb),0.07)", verticalAlign: "middle" } as React.CSSProperties,
  tr: { cursor: "pointer" } as React.CSSProperties,
  rowname: { fontWeight: 600, fontSize: 13.5 } as React.CSSProperties,
  rowsub: { fontSize: 11.5, color: "rgba(var(--a-text-rgb),0.5)", marginTop: 2, fontFamily: "'Courier New', monospace" } as React.CSSProperties,
  chip: (kind: "success" | "warn" | "neutral") => ({
    ...
    background: kind === "success" ? "rgba(93,212,144,0.16)" : kind === "warn" ? "rgba(255,184,77,0.16)" : "rgba(var(--a-neutral-rgb),0.07)",
    color: kind === "success" ? "#5DD490" : kind === "warn" ? "#ffb84d" : "rgba(var(--a-text-rgb),0.5)",
  } as React.CSSProperties),
  pager: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "14px 18px", fontSize: 12.5, color: "rgba(var(--a-text-rgb),0.5)" } as React.CSSProperties,
  empty: { padding: "48px 20px", textAlign: "center", color: "rgba(var(--a-text-rgb),0.5)" } as React.CSSProperties,
