...
const S = {
  page: { padding: 32, color: "#DFE8ED", maxWidth: 900 } as React.CSSProperties,
  header: {
    background: "#1d1434", border: "1px solid rgba(153,0,255,0.2)", borderRadius: 16, padding: "24px 28px",
  ...
  doc: { fontFamily: "'Courier New', monospace", color: "rgba(223,232,237,0.5)", fontSize: 13, marginTop: 4 } as React.CSSProperties,
  addr: { color: "rgba(223,232,237,0.5)", fontSize: 13, marginTop: 6 } as React.CSSProperties,
  ...
  panel: { background: "#1d1434", border: "1px solid rgba(153,0,255,0.2)", borderRadius: 16, padding: "26px 28px", marginBottom: 20 } as React.CSSProperties,
  h3: { fontFamily: "'Lexend', sans-serif", fontSize: 15, fontWeight: 600, marginBottom: 4 } as React.CSSProperties,
  note: { fontSize: 12.5, color: "rgba(223,232,237,0.5)", marginBottom: 22, maxWidth: "62ch" } as React.CSSProperties,
  ...
  circle: (state: "done" | "current" | "upcoming") => ({
    ...
    background: state === "done" ? "rgba(93,212,144,0.16)" : state === "current" ? "#9900ff" : "rgba(255,255,255,0.07)",
    color: state === "done" ? "#5DD490" : state === "current" ? "#fff" : "rgba(223,232,237,0.5)",
    zIndex: 1,
  } as React.CSSProperties),
  tlabel: { fontFamily: "'Lexend', sans-serif", fontSize: 12.5, fontWeight: 700, marginTop: 10 } as React.CSSProperties,
  ttime: { fontFamily: "'Courier New', monospace", fontSize: 11, color: "rgba(223,232,237,0.5)", marginTop: 3 } as React.CSSProperties,
  ...
  fileInput: { fontSize: 13, color: "rgba(223,232,237,0.7)" } as React.CSSProperties,
  contactsGrid: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 } as React.CSSProperties,
  miniCard: { border: "1px solid rgba(255,255,255,0.07)", borderRadius: 12, padding: "14px 16px" } as React.CSSProperties,
  ...
  miniDetail: { fontSize: 12, color: "rgba(223,232,237,0.5)", marginTop: 2 } as React.CSSProperties,
  ...
  fieldLabel: { fontSize: 12, fontWeight: 600, color: "rgba(223,232,237,0.5)" } as React.CSSProperties,
  input: {
