      ...
      <div className={styles.shell}>
        ...
        <main className={styles.main}>
          ...
          <Routes>
            ...
            <Route path="/stock/suppliers"          element={<ProtectedRoute path="/stock/suppliers"          element={<EstoqueScreen />} />} />
            <Route path="/stock/suppliers/new"      element={<ProtectedRoute path="/stock/suppliers/new"      element={<SupplierFormScreen />} />} />
            <Route path="/stock/suppliers/:id/edit" element={<ProtectedRoute path="/stock/suppliers/:id/edit" element={<SupplierFormScreen />} />} />
            <Route path="/stock/invoices"           element={<ProtectedRoute path="/stock/invoices"           element={<EstoqueScreen />} />} />
            ...
            <Route path="/commercial/partners" element={<ProtectedRoute path="/commercial/partners" element={<CommercialScreen />} />} />
            <Route path="/commercial/partners/new" element={<ProtectedRoute path="/commercial/partners/new" element={<PartnerFormScreen />} />} />
            <Route path="/commercial/partners/:id/edit" element={<ProtectedRoute path="/commercial/partners/:id/edit" element={<PartnerFormScreen />} />} />
            <Route path="*" element={<Navigate to="/dashboard" replace />} />
          </Routes>
        </main>
      </div>
