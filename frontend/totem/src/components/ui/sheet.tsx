...
function SheetOverlay({
  ...
  return (
    <ModalOverlayPrimitive
      ...
      isDismissable
      className={cn(
        "fixed inset-0 z-50 bg-black/55 transition-opacity duration-150 data-entering:opacity-0 data-exiting:opacity-0 supports-backdrop-filter:backdrop-blur-xs",
        className
      )}
      {...props}
    >
