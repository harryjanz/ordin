...
- PR ainda não aberta — aguardando decisão do usuário sobre commit/PR/merge, e confirmação de que o vídeo toca de verdade (o item acima ainda não tem confirmação 100% conclusiva).
