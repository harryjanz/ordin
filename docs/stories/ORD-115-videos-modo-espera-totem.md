...
- PR ainda não aberta — aguardando decisão do usuário sobre commit/PR/merge, e confirmação de que o vídeo toca de verdade (item pendente de rodada anterior, ainda sem confirmação 100% conclusiva).
