...
- PR ainda não aberta — aguardando decisão do usuário sobre commit/PR/merge, e confirmação de que (a) o vídeo toca de verdade e (b) o campo de editar nome agora aceita digitação normal — os dois itens pendentes de rodadas anteriores, sem confirmação 100% conclusiva via automação.
