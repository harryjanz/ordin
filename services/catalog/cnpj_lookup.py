...
Cópia de services/company/infrastructure/cnpj_lookup.py (ORD-202) — mesmo
padrão já usado por services/catalog/cnpj.py (ORD-182/A6): "cada serviço
copia ou importa esses utilitários" (CLAUDE.md). Lógica pura, sem SQLAlchemy,
sem acoplamento a Company — só o import de is_alphanumeric_cnpj muda (aponta
pra services/catalog/cnpj.py local, não domain/cnpj.py de company-service).
"""
import logging
from dataclasses import dataclass, replace

import httpx
from cnpj import is_alphanumeric_cnpj
