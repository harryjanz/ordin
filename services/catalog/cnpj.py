...
Cópia de services/company/domain/cnpj.py (ORD-182/A6) — mesmo padrão já usado
por services/shared/auth.py e config.py, "cada serviço copia ou importa esses
utilitários" (CLAUDE.md). Lógica pura, sem I/O, sem SQLAlchemy — nunca
reimplementar, só copiar (ver memória de projeto sobre validação de CNPJ).
"""
